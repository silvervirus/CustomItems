...
namespace CustomItems.BatteriesLoader
{
    public class RequirementsLoaders
    {
        private readonly string _pluginDirectory;

        public RequirementsLoaders()
        {
        ...
        public Dictionary<string, EggInfoData> LoadAllEggInfo()
        {
            ...
            try
            {
                string itemsDirectory = Path.Combine(_pluginDirectory, "Battery");
