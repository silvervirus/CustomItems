...
namespace RamuneLib.Utils
{
    public static class ImageUtils
    {
        ...
        /// <summary>
        /// Loads and returns an <see cref="Sprite"/> loaded from the Assets folder using the filename provided
        /// </summary>
        ...
        /// <summary>
        /// Gets and returns an <see cref="Sprite"/> associated with the given TechType.
        /// </summary>
        /// <param name="techType">The TechType of the sprite to retrieve.</param>
        /// <returns>The retrieved <see cref="Sprite"/>.
        ...
        /// <summary>
        /// Returns the passed <see cref="Sprite"/> as a <see cref="Sprite"/> 
        /// </summary>
