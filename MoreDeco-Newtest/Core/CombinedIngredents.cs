...
public class CombinedIngredents
{
    public static void LoadCombinedIngredientsRequirements()
        {
                ...
                foreach (var eggEntry in allEggInfo)
                {
                    try
                    {
                        ...
                        foreach (string internalName in eggInterName.Split(','))
                        {
                            ...
                            if (eggData.PPIngredients || eggData.CombinedIngredients)
                            {
                               if (eggData.PPIfood || eggData.CombinedFood)
                               {
                               ...
                               else if (eggData.PPIdrink|| eggData.Combineddrink)
                               {
                                   var food = new CloneTemplate(prefab.Info, eggData.ResourceId);
                                   food.ModifyPrefab += obj =>
                                   {
                               ...
                               else if (eggData.PPIItem || eggData.CombinedItem)
                               {
                                   var food = new CloneTemplate(prefab.Info, eggData.ResourceId);
