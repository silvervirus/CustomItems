...
public class AdvancedIngredents
{
     public static void LoadAdvancedIngredientsRequirements()
        {
                    ...
                    try
                    {
                        ...
                        foreach (string internalName in eggInterName.Split(','))
                        {
                           ...
                           UnifiedPrefabsCombined prefab = new UnifiedPrefabsCombined(internalName.Trim(),
                            ...
                            if (eggData.PreIngredients || eggData.AdvancedIngredients)
                            {
                                if (eggData.PIfood || eggData.Advancedfood)
                                {
                                ...
                                else if (eggData.PIdrink|| eggData.Advanceddrink)
                                {
                                    var food = new CloneTemplate(prefab.Info, eggData.ResourceId);
                                    food.ModifyPrefab += obj =>
                                    {
                                ...
                                else if (eggData.PIItem || eggData.AdvancedItem)
                                {
                                    var food = new CloneTemplate(prefab.Info, eggData.ResourceId);
